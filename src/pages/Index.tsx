...
const privileges = [
  ...
  },
  {
    ...
    perks: ["Префикс [DEV] красным", "Член команды разработчиков и администраторов", "Иммунитет к бану и разжалованию", "Полная свобода действий на сервере", "Выдача любых предметов и прав без КД", "Нарушение обязанностей — разжалование разработчиком", "Вечная привилегия"],
  },
];
